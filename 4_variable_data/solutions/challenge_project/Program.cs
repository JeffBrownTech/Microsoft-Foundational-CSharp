...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            // Convert string to array and perform formatting tasks
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    string dogName = ourAnimals[i, 3].Replace("Nickname: ", "");
                    ...
                    foreach (string term in dogSearchTerms)
                    {
                        if (term != null && term != "")
                        {
                            for (int j = 2; j >= 0; j--)
                            {
                                ...
                                {
                                    Console.Write($"\rsearching our dog {dogName} for {term} {icon} {j.ToStrin()}");
                                    Thread.Sleep(350);
                                }
                            ...
                            if (dogDescription.Contains(" " + term + " "))  //interesting solution to match whole words
                            {
                                // #3b update message to reflect term 
                                // #3c set a flag "this dog" is a match
                                Console.WriteLine($"Our dog {dogName} is a {term} match!");
                                thisDog = true;
                                noMatchesDog = false;
                            }
