...
//   - string[,] signifies this is a two-dimensional string array
//   - new string[maxpets, 6] declares an array of {maxpets} rows with 6 columns
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                // Get the pet's age. Can b ? at initial entry.
                do
                {
                    int petAge;
