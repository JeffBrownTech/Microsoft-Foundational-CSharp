    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    // Get value after "Age: " and determine if it is a valid integer
                    int spaceIndex = ourAnimals[i, 2].IndexOf(" ");
                    string currentAgeValue = ourAnimals[i, 2].Remove(0, spaceIndex + 1);
                    bool validInteger = int.TryParse(currentAgeValue, out petAge);

                    if (validInteger == false)
                    {
                        do
                        {
                            Console.WriteLine($"Enter an age for animal {ourAnimals[i, 0]}:");
                            readResult = Console.ReadLine();
                    ...
                    if (ourAnimals[i, 4] == "Physical description: ")
                    {
                        ...
                        {
                            validEntry = false;
                            Console.WriteLine($"Enter physical description for animal {ourAnimals[i, 0]} (size, color, breed, gender, weight, housebroken):");
                            readResult = Console.ReadLine();
                            ...
                            {
                                Console.WriteLine("Physical description cannot be blank and at least 3 characters long.");
                            }
                        } while (validEntry == false);
                    }
                }
            ...
            Console.WriteLine("\nAge and physical description fields are completed for all animals.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: ")
                    {
                        ...
                        {
                            validEntry = false;
                            Console.WriteLine($"Enter a nickname for animal {ourAnimals[i, 0]}");
                            readResult = Console.ReadLine();
                            ...
                            {
                                Console.WriteLine("Animal nickname cannot be blank.");
                            }
                        } while (validEntry == false);
                    }
                    ...
                    if (ourAnimals[i, 5] == "Personality: ")
                    {
                        ...
                        {
                            validEntry = false;
                            Console.WriteLine($"Enter personality details for animal {ourAnimals[i, 0]} (like or dislikes, tricks, energy level):");
                            readResult = Console.ReadLine();
                            ...
                            {
                                Console.WriteLine("Animal nickname cannot be blank and at least 3 characters long.");
                            }
                        } while (validEntry == false);
                    }
                }
            ...
            Console.WriteLine("\nAll animal nicknames and personality descriptions are completed.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
